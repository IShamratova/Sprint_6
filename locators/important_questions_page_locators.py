...
class ImportantQuestionsLocator:
    ...
    FIRST_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.FIRST_ANSWER_TEXT}"]'
    ...
    SECOND_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.SECOND_ANSWER_TEXT}"]'
    ...
    THIRD_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.THIRD_ANSWER_TEXT}"]'
    ...
    FOURTH_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.FOURTH_ANSWER_TEXT}"]'
    ...
    FIFTH_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.FIFTH_ANSWER_TEXT}"]'
    ...
    SIXTH_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.SIXTH_ANSWER_TEXT}"]'
    ...
    SEVENTH_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.SEVENTH_ANSWER_TEXT}"]'
    ...
    EIGHTH_ANSWER = f'.//p[text() = "{ImportantQuestionsPageData.EIGHTH_ANSWER_TEXT}"]'
